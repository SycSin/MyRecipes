  ...
  methods: {
    ...
    async fetchData() {
      try {
        ...
        axios.get(`http://myrecipes-backend:3000/recipes/${this.$route.params.id}`)
            .then(response => {
              this.recipe = response.data[0]
              axios.get(`http://myrecipes-backend:3000/categories/${this.recipe.category}`)
                  .then(response => {
              ...
              axios.get(`http://myrecipes-backend:3000/users/${this.recipe.author}`)
                  .then(response => {
